...
public class TaskType_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_p6qso6_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_p6qso6_e0(editorContext, node));
    editorCell.addEditorCell(this.createRefNodeList_p6qso6_f0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_p6qso6_g0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createConstant_p6qso6_e0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "<");
    editorCell.setCellId("Constant_p6qso6_e0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    style.set(StyleAttributes.PUNCTUATION_RIGHT, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefNodeList_p6qso6_f0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new TaskType_Editor.argumentTypesListHandler_p6qso6_f0(node, "argumentTypes", editorContext);
  ...
  private static class argumentTypesListHandler_p6qso6_f0 extends RefNodeListHandler {
    public argumentTypesListHandler_p6qso6_f0(SNode ownerNode, String childRole, EditorContext context) {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_p6qso6_a5a(editorContext, node);
    }
    ...
    private EditorCell createConstant_p6qso6_a5a(EditorContext editorContext, SNode node) {
      EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
      editorCell.setCellId("Constant_p6qso6_a5a");
      Style style = new StyleImpl();
  ...
  private EditorCell createConstant_p6qso6_g0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ">");
    editorCell.setCellId("Constant_p6qso6_g0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
