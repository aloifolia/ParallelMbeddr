...
public class CompoundLiteral_TextGen extends SNodeTextGen {
  public void doGenerateText(SNode node) {
    if (getBuffer().hasPositionsSupport()) {
      TraceInfoGenerationUtil.createPositionInfo(this, node);
    }
    this.append("(");
    appendNode(SLinkOperations.getTarget(node, "structType", true));
    this.append(")");
    appendNode(SLinkOperations.getTarget(node, "args", true));
    if (getBuffer().hasPositionsSupport()) {
      {
  ...
  protected static Logger LOG = LogManager.getLogger(CompoundLiteral_TextGen.class);
}
