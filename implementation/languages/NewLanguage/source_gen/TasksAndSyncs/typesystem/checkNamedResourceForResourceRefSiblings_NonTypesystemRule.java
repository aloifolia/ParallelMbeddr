    ...
    for (final SNode varRef : ListSequence.fromList(SNodeOperations.getDescendants(namedRessource, "com.mbeddr.core.statements.structure.IVariableReference", false, new String[]{}))) {
      if (ListSequence.fromList(SNodeOperations.getPrevSiblings(namedRessource, false)).any(new IWhereFilter<SNode>() {
        public boolean accept(SNode it) {
          return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(it, "TasksAndSyncs.structure.SyncRessource"), "expression", true), "com.mbeddr.core.statements.structure.IVariableReference") && BehaviorReflection.invokeVirtual((Class<SNode>) ((Class) Object.class), SNodeOperations.cast(SLinkOperations.getTarget(SNodeOperations.cast(it, "TasksAndSyncs.structure.SyncRessource"), "expression", true), "com.mbeddr.core.statements.structure.IVariableReference"), "virtual_getVariable_2486081302460156153", new Object[]{}) == BehaviorReflection.invokeVirtual((Class<SNode>) ((Class) Object.class), varRef, "virtual_getVariable_2486081302460156153", new Object[]{});
        }
      })) {
        {
          MessageTarget errorTarget = new NodeMessageTarget();
