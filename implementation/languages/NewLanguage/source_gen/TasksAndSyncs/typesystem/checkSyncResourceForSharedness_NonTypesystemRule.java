...
public class checkSyncResourceForSharedness_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  public checkSyncResourceForSharedness_NonTypesystemRule() {
  }
    ...
    if (!(SNodeOperations.isInstanceOf(ressourceType, "com.mbeddr.core.pointers.structure.PointerType") && SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(ressourceType, "com.mbeddr.core.pointers.structure.PointerType"), "baseType", true), "TasksAndSyncs.structure.SharedType"))) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(syncResource, "only shared resource or pointer to shared resource allowed", "r:daf934de-3466-4fa8-a227-270fedb7e2f2(TasksAndSyncs.typesystem)", "3227138667937870384", null, errorTarget);
      }
    }
  }
