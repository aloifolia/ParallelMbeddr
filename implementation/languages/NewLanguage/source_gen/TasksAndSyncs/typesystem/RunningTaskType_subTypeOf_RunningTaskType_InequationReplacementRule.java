...
public class RunningTaskType_subTypeOf_RunningTaskType_InequationReplacementRule extends AbstractInequationReplacementRule_Runtime {
  ...
  public void processInequation(final SNode subtype, final SNode supertype, final EquationInfo equationInfo, final TypeCheckingContext typeCheckingContext, IsApplicable2Status status, final boolean inequalityIsWeak, final boolean inequalityIsLessThan) {
    if (ListSequence.fromList(SLinkOperations.getTargets(subtype, "argumentTypes", true)).count() != ListSequence.fromList(SLinkOperations.getTargets(supertype, "argumentTypes", true)).count()) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(equationInfo.getNodeWithError(), "differing argument numbers ", "r:daf934de-3466-4fa8-a227-270fedb7e2f2(TasksAndSyncs.typesystem)", "1304213873212628737", null, errorTarget);
    ...
    }
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:daf934de-3466-4fa8-a227-270fedb7e2f2(TasksAndSyncs.typesystem)", "1304213873212628754", 0, null);
    ...
    }
    {
      ...
      while (argTypeSub_it.hasNext() && argTypeSuper_it.hasNext()) {
        ...
        {
          SNode _nodeToCheck_1029348928467 = equationInfo.getNodeWithError();
          EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:daf934de-3466-4fa8-a227-270fedb7e2f2(TasksAndSyncs.typesystem)", "1304213873212628775", 0, null);
          _info_12389875345.getOuterRulesIdFromInfo(equationInfo);
