...
public class SharedSet_Constraints extends BaseConstraintsDescriptor {
  public SharedSet_Constraints() {
    super("parallelization.structure.SharedSet");
  }
  ...
  public static boolean static_canBeAChild(SNode node, SNode parentNode, SNode link, SNode childConcept, final IOperationContext operationContext) {
    ...
    if (SNodeOperations.isInstanceOf(expressionType, "com.mbeddr.core.pointers.structure.PointerType")) {
      return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(expressionType, "com.mbeddr.core.pointers.structure.PointerType"), "baseType", true), "parallelization.structure.SharedType");
    }
    return false;
  }

  private static SNodePointer canBeChildBreakingPoint = new SNodePointer("r:1131838a-735d-45d7-9c86-9e6994478367(parallelization.constraints)", "3570654511858680087");
}
