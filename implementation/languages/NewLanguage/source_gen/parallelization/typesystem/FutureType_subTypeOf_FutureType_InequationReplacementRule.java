...
public class FutureType_subTypeOf_FutureType_InequationReplacementRule extends AbstractInequationReplacementRule_Runtime {
  ...
  public void processInequation(final SNode subtype, final SNode supertype, final EquationInfo equationInfo, final TypeCheckingContext typeCheckingContext, IsApplicable2Status status, final boolean inequalityIsWeak, final boolean inequalityIsLessThan) {
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:daf934de-3466-4fa8-a227-270fedb7e2f2(parallelization.typesystem)", "1186028049355123334", 0, null);
  ...
  public String getApplicableSubtypeConceptFQName() {
    return "parallelization.structure.FutureType";
  }
