    ...
    if (!(SNodeOperations.isInstanceOf(TypeChecker.getInstance().getTypeOf(SLinkOperations.getTarget(namedRessource, "expression", true)), "com.mbeddr.core.pointers.structure.PointerType"))) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(namedRessource, "pointer to shared ressource expected here", "r:daf934de-3466-4fa8-a227-270fedb7e2f2(parallelization.typesystem)", "483189195558179233", null, errorTarget);
      }
    }
  }
