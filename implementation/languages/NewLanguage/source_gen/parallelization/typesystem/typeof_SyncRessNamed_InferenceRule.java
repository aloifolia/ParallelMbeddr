  ...
  public void applyRule(final SNode syncRessNamed, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:daf934de-3466-4fa8-a227-270fedb7e2f2(parallelization.typesystem)", "6288388922743520276", 0, null);
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:daf934de-3466-4fa8-a227-270fedb7e2f2(parallelization.typesystem)", "6288388922743520146", true), (SNode) typeCheckingContext.typeOf(SLinkOperations.getTarget(syncRessNamed, "expression", true), "r:daf934de-3466-4fa8-a227-270fedb7e2f2(parallelization.typesystem)", "6288388922743520295", true), _info_12389875345);
    }
  }

  public String getApplicableConceptFQName() {
    return "parallelization.structure.SyncRessourceNamed";
  }
