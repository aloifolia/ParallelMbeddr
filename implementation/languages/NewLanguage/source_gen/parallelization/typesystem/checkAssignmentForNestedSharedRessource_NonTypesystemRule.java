    ...
    if (Checker.typeContainsSharedElements(TypeChecker.getInstance().getTypeOf(target))) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(target, "(nested) shared ressource overwriting not allowed", "r:daf934de-3466-4fa8-a227-270fedb7e2f2(parallelization.typesystem)", "483189195558648037", null, errorTarget);
      }
    }
  }
