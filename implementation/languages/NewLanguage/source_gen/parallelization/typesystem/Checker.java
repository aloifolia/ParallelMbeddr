...
public class Checker {
  public static boolean isInCopyPosition(SNode expression) {
    ...
    if (SNodeOperations.isInstanceOf(parent, "com.mbeddr.core.expressions.structure.ParensExpression")) {
      return isInCopyPosition(SNodeOperations.cast(SNodeOperations.getParent(expression), "com.mbeddr.core.expressions.structure.Expression"));
    }
  ...
  public static List<String> checkTypeForUnsharedPointers(SNode type) {
    ...
    if (SNodeOperations.isInstanceOf(type, "com.mbeddr.core.pointers.structure.PointerType")) {
      ...
      if (!(SNodeOperations.isInstanceOf(SLinkOperations.getTarget(pointerType, "baseType", true), "parallelization.structure.SharedType"))) {
        ListSequence.fromList(errorMessages).addElement("node of pointer type must point to shared ressource");
      } else {
        ListSequence.fromList(errorMessages).addSequence(ListSequence.fromList(checkTypeForUnsharedPointers(SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(pointerType, "baseType", true), "parallelization.structure.SharedType"), "baseType", true))));
      }
    ...
    } else if (SNodeOperations.isInstanceOf(type, "parallelization.structure.SharedType")) {
      SNode sharedType = SNodeOperations.cast(type, "parallelization.structure.SharedType");
  ...
  public static boolean pathContainsSharedGet(SNode path) {
    if (SNodeOperations.isInstanceOf(path, "com.mbeddr.core.expressions.structure.GenericDotExpression") && SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(path, "com.mbeddr.core.expressions.structure.GenericDotExpression"), "target", true), "parallelization.structure.SharedGet")) {
      return true;
    ...
    }
    {
      ...
      if (SNodeOperations.isInstanceOf(gde1, "com.mbeddr.core.expressions.structure.GenericDotExpression")) {
        ...
        }
        {
          ...
          if (SNodeOperations.isInstanceOf(exprType1, "parallelization.structure.SharedType")) {
            if (!(SNodeOperations.isInstanceOf(TypeChecker.getInstance().getTypeOf(SLinkOperations.getTarget(gde1, "expression", true)), "parallelization.structure.SharedType"))) {
              return false;
            }
            if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(gde1, "target", true), "parallelization.structure.SharedGet") && !(SNodeOperations.isInstanceOf(SLinkOperations.getTarget(gde2, "target", true), "parallelization.structure.SharedGet"))) {
              return false;
            }
            if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(gde1, "target", true), "parallelization.structure.SharedSet") && !(SNodeOperations.isInstanceOf(SLinkOperations.getTarget(gde2, "target", true), "parallelization.structure.SharedSet"))) {
              return false;
            }
            // TODO 
          }
