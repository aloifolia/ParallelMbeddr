...
public class SharedBuilder {
  ...
  private Set<SNode> getStructsWithNestedSharedDataRec(SNode struct) {
    ...
    for (SNode member : ListSequence.fromList(SUDeclaration_Behavior.call_members_9101132143318613823(struct))) {
      ...
      if (SNodeOperations.isInstanceOf(strippedMemberType, "parallelization.structure.SharedType")) {
  ...
  public Map<SNode, SNode> getSharedToResolvedTypes() {
    ...
    ListSequence.fromList(SModelOperations.getRoots(model, "com.mbeddr.core.modules.structure.ImplementationModule")).visitAll(new IVisitor<SNode>() {
      public void visit(SNode module) {
        ListSequence.fromList(SNodeOperations.getDescendants(module, "parallelization.structure.SharedType", false, new String[]{})).visitAll(new IVisitor<SNode>() {
  ...
  public void buildStructsForSharedTypes(Map<SNode, SNode> sharedToResolvedTypes, Map<SNode, SNode> structToSharedModule, SNode genericSharedModule) {
    for (IMapping<SNode, SNode> sharedToResolved : MapSequence.fromMap(sharedToResolvedTypes).sort(new ISelector<IMapping<SNode, SNode>, Integer>() {
      public Integer select(IMapping<SNode, SNode> it) {
        return ListSequence.fromList(SNodeOperations.getDescendants(it.value(), "parallelization.structure.SharedType", false, new String[]{})).count();
      }
    }, true)) {
  ...
  public SNode mapSharedToStructType(SNode sharedType) {
    ...
    if (knownStructType == null) {
      ...
      SNode nestedSharedType = ListSequence.fromList(SNodeOperations.getDescendants(sharedTypeCopy, "parallelization.structure.SharedType", false, new String[]{})).first();
  ...
  private SNode buildSharedStruct(final SNode type) {
    ...
    return new _FunctionTypes._return_P0_E0<SNode>() {
      public SNode invoke() {
        ...
        final SNode node_969505516143466628 = new _FunctionTypes._return_P0_E0<SNode>() {
          public SNode invoke() {
            SNode res = SConceptOperations.createNewNode("com.mbeddr.core.expressions.structure.VoidType", null);
            return res;
          }
        ...
        final SNode node_4335879941187172855 = new _FunctionTypes._return_P0_E0<SNode>() {
          public SNode invoke() {
            ...
            SLinkOperations.setTarget(res, "dummyType", node_969505516143466628, true);
  ...
  private static String structNameForType(SNode type) {
    {
      ...
      if (SNodeOperations.isInstanceOf(sharedType, "parallelization.structure.SharedType")) {
  ...
  public static SNode buildMutexAttribute(final TemplateQueryContext genContext) {
    return new _FunctionTypes._return_P0_E0<SNode>() {
      public SNode invoke() {
        ...
        final SNode node_969505516143512426 = new _FunctionTypes._return_P0_E0<SNode>() {
          public SNode invoke() {
            SNode res = SConceptOperations.createNewNode("com.mbeddr.core.expressions.structure.VoidType", null);
            return res;
          }
        ...
        final SNode node_8001979070764659655 = new _FunctionTypes._return_P0_E0<SNode>() {
          public SNode invoke() {
            SNode res = SConceptOperations.createNewNode("com.mbeddr.core.statements.structure.ArbitraryTextType", null);
            SPropertyOperations.set(res, "requiredStdHeader", ("<pthread.h>"));
            SLinkOperations.setTarget(res, "dummyType", node_969505516143512426, true);
  ...
  public SNode buildDestroyMutexFunction() {
    final SNode mutex = new _FunctionTypes._return_P0_E0<SNode>() {
      public SNode invoke() {
        ...
        final SNode node_969505516143526964 = new _FunctionTypes._return_P0_E0<SNode>() {
          public SNode invoke() {
            SNode res = SConceptOperations.createNewNode("com.mbeddr.core.expressions.structure.VoidType", null);
            return res;
          }
        ...
        final SNode node_4335879941189134770 = new _FunctionTypes._return_P0_E0<SNode>() {
          public SNode invoke() {
            SNode res = SConceptOperations.createNewNode("com.mbeddr.core.statements.structure.ArbitraryTextType", null);
            SPropertyOperations.set(res, "requiredStdHeader", ("<pthread.h>"));
            SLinkOperations.setTarget(res, "dummyType", node_969505516143526964, true);
  ...
  private Pair<SNode, SNode> buildInitAndDestroyBase(SNode baseType, final SNode basePath) {
    ...
    if (baseFunctions != null) {
      ...
      initBase = buildMutexInitCall(basePath, SNodeOperations.cast(_baseType.value, "parallelization.structure.SharedType"));
      destroyBase = SNodeOperations.copyNode(initBase);
  ...
  private void buildMutexFunctionsForSharedType(SNode sharedType) {
    ...
    if (baseFunctions == null && !(SNodeOperations.isInstanceOf(SLinkOperations.getTarget(sharedType, "baseType", true), "parallelization.structure.SharedType"))) {
      return;
    }
  ...
  private void buildMutexFunctionsForArrayType(SNode arrayType) {
    ...
    if (baseFunctions == null && !(SNodeOperations.isInstanceOf(baseType, "parallelization.structure.SharedType"))) {
      return;
    }
  ...
  private void buildMutexFunctionsForStructType(final SNode structType) {
    if (!(ListSequence.fromList(SUDeclaration_Behavior.call_members_9101132143318613823(SLinkOperations.getTarget(structType, "struct", false))).any(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return getValueForType(typesToMutexFunctions, removeArraySizesShallowly(SLinkOperations.getTarget(it, "type", true))) != null || SNodeOperations.isInstanceOf(SLinkOperations.getTarget(it, "type", true), "parallelization.structure.SharedType");
      }
    }))) {
      return;
    }
    ...
    for (final SNode member : ListSequence.fromList(SUDeclaration_Behavior.call_members_9101132143318613823(SLinkOperations.getTarget(structType, "struct", false))).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return getValueForType(typesToMutexFunctions, removeArraySizes(SLinkOperations.getTarget(it, "type", true))) != null || SNodeOperations.isInstanceOf(SLinkOperations.getTarget(it, "type", true), "parallelization.structure.SharedType");
      }
    })) {
  ...
  public Pair<SNode, SNode> buildMutexCallsForVariable(final SNode varRef, SNode declaration) {
    ...
    if (mutexFunctions == null) {
      if (!(SNodeOperations.isInstanceOf(type, "parallelization.structure.SharedType"))) {
        return null;
      }
      // declaration must be of type shared<> 
      SNode initCall = buildMutexInitCall(varRef, SNodeOperations.cast(type, "parallelization.structure.SharedType"));
  ...
  private boolean buildSharedModulesRec(SNode type, boolean buildInAnyCase) {
    ...
    }
    {
      ...
      if (SNodeOperations.isInstanceOf(structType, "com.mbeddr.core.udt.structure.StructType")) {
        ...
        ListSequence.fromList(SUDeclaration_Behavior.call_members_9101132143318613823(SLinkOperations.getTarget(structType, "struct", false))).visitAll(new IVisitor<SNode>() {
          public void visit(SNode it) {
            membersHaveNestedShared.value = buildSharedModulesRec(SLinkOperations.getTarget(it, "type", true), false) || SNodeOperations.isInstanceOf(SLinkOperations.getTarget(it, "type", true), "parallelization.structure.SharedType") || membersHaveNestedShared.value;
          }
        });
