...
public class SyncBuilder {
  ...
  public static SNode resolveNestedTypeDefsAndConstants(SNode sharedType) {
    SNode resolvedType = SNodeOperations.copyNode(sharedType);
    ListSequence.fromList(SNodeOperations.getDescendants(resolvedType, "com.mbeddr.core.modules.structure.GlobalConstantRef", false, new String[]{})).visitAll(new IVisitor<SNode>() {
    ...
    ListSequence.fromList(SNodeOperations.getDescendants(resolvedType, "com.mbeddr.core.udt.structure.TypeDefType", false, new String[]{})).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
  ...
  public static SNode buildVoidFunction(List<SNode> statements, List<SNode> arguments, final String name, final boolean inline, final boolean exported) {
    SNode function = new _FunctionTypes._return_P0_E0<SNode>() {
      public SNode invoke() {
        final SNode node_4335879941161855081 = new _FunctionTypes._return_P0_E0<SNode>() {
          public SNode invoke() {
            SNode res = SConceptOperations.createNewNode("com.mbeddr.core.expressions.structure.VoidType", null);
            return res;
          }
        }.invoke();
        final SNode node_4335879941161855085 = new _FunctionTypes._return_P0_E0<SNode>() {
          public SNode invoke() {
            SNode res = SConceptOperations.createNewNode("com.mbeddr.core.statements.structure.StatementList", null);
            return res;
          }
        }.invoke();
        SNode node_4335879941161855076 = new _FunctionTypes._return_P0_E0<SNode>() {
          public SNode invoke() {
            ...
            SLinkOperations.setTarget(res, "type", node_4335879941161855081, true);
            SLinkOperations.setTarget(res, "body", node_4335879941161855085, true);
            return res;
          }
        }.invoke();
        return node_4335879941161855076;
      }
    }.invoke();
  ...
  public static Map<SNode, SNode> getSharedToResolvedTypes(SModel model) {
    ...
    ListSequence.fromList(SModelOperations.getRoots(model, "com.mbeddr.core.modules.structure.ImplementationModule")).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
        ListSequence.fromList(SNodeOperations.getDescendants(it, "TasksAndSyncs.structure.SharedType", false, new String[]{})).visitAll(new IVisitor<SNode>() {
          public void visit(SNode it) {
            MapSequence.fromMap(sharedToResolvedTypes).put(it, SyncBuilder.resolveNestedTypeDefsAndConstants(it));
          }
        });
      }
    });
