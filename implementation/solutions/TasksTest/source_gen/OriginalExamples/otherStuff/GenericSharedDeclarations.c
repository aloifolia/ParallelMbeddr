...
void GenericSharedDeclarations_mutexInit_3(struct GenericSharedDeclarations_SharedOf_ArrayOf_SharedOf_int32_0_1* var) 
{
...
void GenericSharedDeclarations_mutexInit_5(struct GenericSharedDeclarations_SharedOf_ArrayOf_SharedOf_int32_0_0* var) 
{
  pthread_mutex_init(&var->mutex,&GenericSharedDeclarations_mutexAttribute_0);
...
void GenericSharedDeclarations_mutexDestroy_5(struct GenericSharedDeclarations_SharedOf_ArrayOf_SharedOf_int32_0_0* var) 
{
...
void GenericSharedDeclarations_mutexDestroy_3(struct GenericSharedDeclarations_SharedOf_ArrayOf_SharedOf_int32_0_1* var) 
{
  pthread_mutex_destroy(&var->mutex);
  GenericSharedDeclarations_mutexInit_2(((struct GenericSharedDeclarations_SharedOf_int32_0*)(var->value)), 5);
}
