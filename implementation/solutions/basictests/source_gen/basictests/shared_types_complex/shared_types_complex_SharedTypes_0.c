...
{
  GenericSharedDeclarations_mutexInit_8(((GenericSharedDeclarations_SharedOf_ArrayOf_int32_0_t*)(var->s1)), 6);
  GenericSharedDeclarations_mutexInit_8(((GenericSharedDeclarations_SharedOf_ArrayOf_int32_0_t*)(var->s2)), 6);
}
...
void shared_types_complex_SharedTypes_0_mutexDestroy_13(shared_types_complex_SharedTypes_0_SharedOf_A4_0_t* var) 
{
  pthread_mutex_destroy(&var->mutex);
  shared_types_complex_SharedTypes_0_mutexDestroy_12(&var->value);
}

void shared_types_complex_SharedTypes_0_mutexDestroy_12(shared_types_complex_SharedTypes_0_A4_t* var) 
{
  GenericSharedDeclarations_mutexDestroy_8(((GenericSharedDeclarations_SharedOf_ArrayOf_int32_1_t*)(var->s)), 6);
}
...
void shared_types_complex_SharedTypes_0_mutexInit_13(shared_types_complex_SharedTypes_0_SharedOf_A4_0_t* var) 
{
  pthread_mutex_init(&var->mutex,&GenericSharedDeclarations_mutexAttribute_0);
  shared_types_complex_SharedTypes_0_mutexInit_12(&var->value);
}
...
{
  GenericSharedDeclarations_mutexDestroy_8(((GenericSharedDeclarations_SharedOf_ArrayOf_int32_0_t*)(var->s1)), 6);
  GenericSharedDeclarations_mutexDestroy_8(((GenericSharedDeclarations_SharedOf_ArrayOf_int32_0_t*)(var->s2)), 6);
}
...
void shared_types_complex_SharedTypes_0_mutexInit_12(shared_types_complex_SharedTypes_0_A4_t* var) 
{
  GenericSharedDeclarations_mutexInit_8(((GenericSharedDeclarations_SharedOf_ArrayOf_int32_1_t*)(var->s)), 6);
}
