...
void GenericSharedDeclarations_mutexInit_12(GenericSharedDeclarations_SharedOf_ArrayOf_int32_0_t* var, int32_t size_0) 
{
...
void GenericSharedDeclarations_mutexDestroy_12(GenericSharedDeclarations_SharedOf_ArrayOf_int32_0_t* var, int32_t size_0) 
{
  for ( int32_t __i_5 = 0; __i_5 < size_0; __i_5++ )
  {
...
void GenericSharedDeclarations_mutexDestroy_8(GenericSharedDeclarations_SharedOf_ArrayOf_int32_1_t* var, int32_t size_0) 
{
...
void GenericSharedDeclarations_mutexInit_8(GenericSharedDeclarations_SharedOf_ArrayOf_int32_1_t* var, int32_t size_0) 
{
  for ( int32_t __i_4 = 0; __i_4 < size_0; __i_4++ )
  {
