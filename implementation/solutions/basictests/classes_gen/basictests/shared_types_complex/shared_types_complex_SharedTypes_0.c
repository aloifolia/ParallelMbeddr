...
{
  GenericSharedDeclarations_mutexDestroy_12(((GenericSharedDeclarations_SharedOf_ArrayOf_int32_1_t*)(var->s)), 6);
}
...
{
  GenericSharedDeclarations_mutexInit_12(((GenericSharedDeclarations_SharedOf_ArrayOf_int32_1_t*)(var->s)), 6);
}
