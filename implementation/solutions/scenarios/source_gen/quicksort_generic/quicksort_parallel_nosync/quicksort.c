...
static GenericTaskDeclarations_VoidFuture_t quicksort_futureInit_a1a2a0a7(int32_t middle, int32_t left, quicksort_Generic_t generics[QUICKSORT_numberOfGenerics]);

static GenericTaskDeclarations_VoidFuture_t quicksort_futureInit_a2a2a0a7(int32_t middle, int32_t right, quicksort_Generic_t generics[QUICKSORT_numberOfGenerics]);
...
static void quicksort_quickSort(quicksort_Generic_t generics[QUICKSORT_numberOfGenerics], int32_t left, int32_t right) 
{
  if ( left < right ) 
  {
    ...
    {
      printf("multi!\n");
      GenericTaskDeclarations_VoidFuture_t sorter1 = quicksort_futureInit_a1a2a0a7(middle, left, generics);
      GenericTaskDeclarations_VoidFuture_t sorter2 = quicksort_futureInit_a2a2a0a7(middle, right, generics);
...
static GenericTaskDeclarations_VoidFuture_t quicksort_futureInit_a2a2a0a7(int32_t middle, int32_t right, quicksort_Generic_t generics[QUICKSORT_numberOfGenerics]) 
{
  ...
  args_a2a2a0a7->generics = generics;
