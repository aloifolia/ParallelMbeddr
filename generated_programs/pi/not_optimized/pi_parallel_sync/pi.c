...
static inline GenericTaskDeclarations_Task_t pi_taskInit_a11a5(GenericSharedDeclarations_SharedOf_uint32_0_t* counterPointer, queue_SharedTypes_0_SharedOf_Queue_0_t* queuePointer);
...
int32_t main(int32_t argc, char* argv[]) 
{
  ...
  GenericTaskDeclarations_Task_t mapperTask = pi_taskInit_a11a5(counterPointer, queuePointer);
