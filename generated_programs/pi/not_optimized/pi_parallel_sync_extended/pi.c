...
static void pi_reduce(GenericSharedDeclarations_SharedOf_long_double_0_t* result, pi_SharedTypes_0_SharedOf_ArrayOf_SharedOf_FlaggedQueue_0_0_t* resultQueues) 
{
  ...
  //printf("so... => count: \n");
...

      {
        ...
        GenericSyncDeclarations_startSyncFor3Mutexes(&(myQueues)->mutex, &(resultQueue)->mutex, &(isFull2)->mutex);
        {
          /* 
...

          {
            ...
            //printf("in3\n");
                ...
                GenericSyncDeclarations_stopSyncFor3Mutexes(&(myQueues)->mutex, &(resultQueue)->mutex, &(isFull2)->mutex);
            //printf("out3\n");
                return ;
              }
            }
