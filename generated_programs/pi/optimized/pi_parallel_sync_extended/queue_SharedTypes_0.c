...
{
  GenericSharedDeclarations_mutexInit_0(((GenericSharedDeclarations_SharedOf_long_double_0_t*)(var->data)), 1000);
}
...
{
  GenericSharedDeclarations_mutexDestroy_0(((GenericSharedDeclarations_SharedOf_long_double_0_t*)(var->data)), 1000);
}
